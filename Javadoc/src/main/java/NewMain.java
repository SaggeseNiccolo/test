...
* where xy is the two-digit hexadecimal representation of the byte. </li>
* </ul>
...
public class NewMain {
    /**
     * <b> Deprecated. </b>
     * <i> The resulting string may vary depending on the platform's default encoding. 
     ...
     * <i> <b> Note: </b> The World Wide Web Consortium Recommendation states that UTF-8 should be used. 
     * Not doing so may introduce incompatibilites. </i>
     * @param s String to be translated.
